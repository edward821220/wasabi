...
contract ERC20WasabiPool is AbstractWasabiPool {
    ...
    function getLiquidityAddress() public view override returns (address) {
    ...
    function validateAndWithdrawPayment(uint256 _premium, string memory _message) internal override {
        ...
        require(token.allowance(_msgSender(), address(this)) >= (_premium + feeAmount) && _premium > 0, _message);
    ...
    /// @inheritdoc IWasabiPool
    function withdrawETH(uint256 _amount) external payable override onlyOwner {
