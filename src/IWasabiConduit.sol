...
interface IWasabiConduit {
     ...
     */
    function transferToken(address _nft, uint256 _tokenId, address _target) external;
     ...
     * @dev Accpets the Ask
     */
    function acceptAsk(WasabiStructs.Ask calldata _ask, bytes calldata _signature) external payable returns (uint256);
